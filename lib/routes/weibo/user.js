    ...
    let resultItems = await Promise.all(
        cards
            ...
            .map(async (item) => {
                ...
                let title = formatExtended.title;
                ...
                if (displayVideo === '1') {
                    ...
                    if (item.mblog.retweeted_status) {
                        description = weiboUtils.formatVideo(description, item.mblog.retweeted_status, title)[0];
                        title = weiboUtils.formatVideo(description, item.mblog.retweeted_status, title)[1];
                    } else {
                        description = weiboUtils.formatVideo(description, item.mblog, title)[0];
                        title = weiboUtils.formatVideo(description, item.mblog, title)[1];
                    }
                }
